...
print(sdk.add_plate(data_file_locations, plate_map_location, sample_plate_id, sample_plate_name, sample_description_file))
```
<hr>
...
print(sdk.start_analysis(name, project_id, sample_ids=sample_ids, analysis_protocol_name=analysis_protocol_name))
```
<hr>
