...
###### <u>Returns</u>
`projects`: (`list` or `DataFrame`) `list` or `DataFrame` of project objects for the authenticated user.
...
###### <u>Returns</u>
`samples`: (`list` or `DataFrame`) List or DataFrame of sample objects for the authenticated user.
